...
export const SliderRail = memo(({ getRailProps, onSlideStart, onSlideEnd }) => {
...
export const Handle = memo(
  ({
    ...
    const { onKeyDown: handleKeyDownEvent, ...handleProps } =
      getHandleProps(id);
...
export const Track = memo(
  ({ source, active, target, getTrackProps, disabled }) => {
    return (
      <div
        style={{
          position: "absolute",
...
// TICK COMPONENT
// *******************************************************
export const Tick = memo(({ tick, count, format }) => {
  return (
    <div>
      <div
        style={{
