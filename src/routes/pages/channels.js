...
function Channels({ category, categoryTitle }) {
      ...
      <Nav
        title={
          <span>
            ...
            <span className="subpage">Channels</span>
          </span>
        }
      />
                ...
                <div className={"cards cards--horizontal"}>
                  {genres &&
                    genres.popular.map((genre) => (
                      <PopularChannel key={genre.label} name={genre.label} />
                    ))}
                </div>
              </div>
            </div>
            ...
            <div className={"cards cards--grid"}>
              {genres &&
                genres.all.map((genre) => (
                  <Channel key={genre.label} name={genre.label} />
                ))}
            </div>
          </section>
        </div>
